...
export default function Project() {
  ...
  // Set for current user immediately
  setCurrentUser(u);
  setTakenUsers((prev) => [...prev, u.name]); 

  // Delay publishing until stompClient is ready
  if (stompClient && stompClient.connected) {
    ...
    console.log("⏳ Waiting for WebSocket to connect before sending hero selection...");
  }
};
  ...
  return (
    ...
    >
      ...
      >
        ...
        <h3 style={{ marginLeft: "160px", color: "yellow", fontWeight: "bold" }}>
