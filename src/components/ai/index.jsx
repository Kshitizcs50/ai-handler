    ...
    <div className="backdrop-blur-md bg-white/10 border border-white/20 rounded-3xl shadow-2xl w-full h-[90vh] flex flex-col overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto w-full p-6 space-y-4">
        {messages.map((msg, idx) => (
          ...
          >
            {msg.role === "assistant" && (
              <div className="w-10 h-10 bg-blue-600 text-white font-bold flex items-center justify-center rounded-full shadow">
                AI
              </div>
            )}
            <div
            ...
            {msg.role === "user" && (
              <div className="w-10 h-10 bg-emerald-600 text-white font-bold flex items-center justify-center rounded-full shadow">
                U
              </div>
            )}
          </motion.div>
