...
export default function Login() {
  ...
  return (
    <main className="relative flex items-center justify-center h-screen overflow-hidden px-4 sm:px-6">
      ...
      <motion.div
        className="absolute border-2 border-purple-500 rounded-full w-[250px] sm:w-[350px] md:w-[400px] h-[250px] sm:h-[350px] md:h-[400px] opacity-30"
        animate={{ rotate: 360 }}
      ...
      <motion.div
        ...
        className="relative z-10 bg-black/70 p-6 sm:p-8 md:p-10 rounded-2xl shadow-2xl border border-purple-500 w-full max-w-md"
      >
        {/* Typewriter Title with Glow */}
        <h1 className="text-xl sm:text-2xl md:text-3xl font-extrabold text-purple-400 mb-6 text-center drop-shadow-[0_0_15px_rgba(168,85,247,0.8)]">
          {title}
        </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            className="w-full py-2 sm:py-3 bg-gradient-to-r from-purple-600 to-blue-700 rounded text-white font-bold tracking-wide shadow-lg hover:scale-105 transform transition hover:shadow-[0_0_25px_rgba(147,51,234,0.9)] text-sm sm:text-base"
          >
            LOGIN
          </button>
        </form>
